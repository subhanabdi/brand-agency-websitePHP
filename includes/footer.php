...
(800) 861-8851">(800) 861-8851</a>
                                    </li>
                                    <li>
                                       <span class="icon"
                                          ><i class="icofont-send-mail"></i
                                          ></span>
                                       <a href="mailto:sales@marketeerpros.com">sales@marketeerpros.com</a>
                                    </li>
                                    <li>
                                       <span class="icon"
                                          ><i class="icofont-send-mail"></i
                                          ></span>
                                       <a href="mailto:info@marketeerpros.com">info@marketeerpros.com</a>
                                    </li>
                                    <li>
                                       <span class="icon"
                                          ><i class="icofont-google-map"></i
                                          ></span>
                                       110 Plaza West, 3031 Tisch Way, San Jose, CA 95128
                                    </li>
                                 </ul>
                              </div>
                           </div>
                              ...
                              <div class="footer-widget">
                                 ...
                                 <ul class="footer-menu">
                                    <li>
                                       ...
                                       <i class="icofont-rounded-double-right"></i>Search Engine Optimization</a>
                                    </li>
                                    <li>
                                       <a class="footer-link" href="javascript:;">
                                       <i class="icofont-rounded-double-right"></i>Pay Per Click</a>
                                    </li>
                                    <li>
                                       <a class="footer-link" href="javascript:;">
                                    ...
                                    <li>
                                       <a class="footer-link" href="javascript:;">
                                       <i class="icofont-rounded-double-right"></i>Content Marketing Services</a>
                                    </li>
                                    <li>
                                       <a class="footer-link" href="javascript:;">
                                       <i class="icofont-rounded-double-right"></i>Web Development Services</a>
                                    </li>
                                    <li>
                                       <a class="footer-link" href="javascript:;">
                                       <i class="icofont-rounded-double-right"></i>Web Design Services</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                          <!--  <div class="footer-col">
                           ...
                           <div class="footer-col">
                              <div class="footer-widget">
                                 ...
                                 <p>
                                    We have a proven track record of increasing digital presence and digital communication for our clients.
                                 </p>
                                 <ul class="footer-social">
                                    <li class="footer-social-item">
                                       <a class="footer-social-link" href="https://www.facebook.com/Creative-Design-Masters-131533765770416" target="_blank"><i class="icofont-facebook"></i></a>
                                    </li>
                                    <li class="footer-social-item">
                                       <a class="footer-social-link" href="https://twitter.com/CDesignmasters" target="_blank"><i class="icofont-twitter"></i></a>
                                    </li>
                                    <li class="footer-social-item">
                                       <a class="footer-social-link" href="https://www.instagram.com/creativedesignmasters" target="_blank"><i class="icofont-instagram"></i></a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                  ...
                  <div class="col-12">
                     <p>
                       ...
                       <!--  <a href="https://hasthemes.com/">HasThemes</a> -->
                        All Rights Reserved. Powered by <a href="https://www.creativedesignmasters.com" target="_blank">Creative Design Masters</a>
                     </p>
                  </div>
               </div>
            </div>
...
<div class="popupMain LoginPopup">
   ...
   <div class="align-items-center">
      ...
      <div class="popform-holder">
         <div class="popTxt">
            <h6>SIGN UP NOW </h6>
            <span>Let's Create a Successful Brand Story</span>
            <!--  <p>Starting From <span>$199</span></p> -->
         </div>
         <form action="" method="POST">
            <div class="popup-bdy">
               <div class="frmicon-box">
                  <span class="field-icon name-icon"></span>
                  <input type="text" placeholder="Full Name" name="con_name" id="name" required>
               </div>
               <div class="frmicon-box">
                  <span class="field-icon email-icon"></span>
                  <input type="email" placeholder="Email Address" name="con_email" id="email" required>
               </div>
               <div class="frmicon-box newcountrycode">
                  <span class=""></span>
                  <select name="packages" required="">
                     <option disabled="disabled" selected>Select your Service</option>
                     <option value="seo">Search Engine Optimization</option>
                     <option value="ppc">Pap Per Click</option>
                     <option value="smm">Social Media Marketing</option>
                     <option value="cms">Content Marketing Services</option>
                  </select>
               </div>
               <div class="frmicon-box phonecode">
                  ...
                  <input type="hidden" placeholder="Package" name="packageid"  class="packageid" required>
               </div>
               <input type="submit" name="submit" value="Submit" class="popup-btn">
            </div>
         </form>
      </div>
   </div>
